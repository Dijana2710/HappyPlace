const translations = {
    ...
    hr: {
        ...
        okuci_podnaslov:
            "Nova, kvalitetno uređena i moderno opremljena kuća, ključ u ruke",
        ...
        kontakt_uvod:
            "Za dodatne informacije i dogovor oko razgledavanja slobodno nam se javite.",

        kontakt_vlasnik:
            "IZRAVNO OD VLASNIKA",

        kontakt_zainteresirani:
            "Zainteresirani ste za nekretninu?",

        kontakt_pitanja:
            "Rado ćemo odgovoriti na dodatna pitanja i, prema dogovoru, organizirati razgledavanje nekretnine.",

        kontakt_dokumentacija:
            "Ozbiljnim zainteresiranim kupcima možemo omogućiti uvid u relevantnu dokumentaciju, zemljišnoknjižni izvadak te račune vezane uz troškove režija.",
        ...
        lokacija_podnaslov:
            "Mirno mjesto nadomak Virovitice",

        lokacija_udaljenost:
            "8 km od centra Virovitice",

        lokacija_glavni_naslov:
            "Sve potrebno za svakodnevni život nadohvat je ruke.",

        lokacija_opis:
            "Nekretnina se nalazi u općini Špišić Bukovica, svega 8 km od centra Virovitice, na lokaciji koja spaja mirnije stanovanje s vrlo dobrom dostupnošću svakodnevnih sadržaja.",
        ...
        lokacija_blizina_opis:
            "Ambulanta, ljekarna, pošta, trgovine, mesnica i autobusna stanica.",
        ...
        lokacija_minute_opis:
            "Osnovna škola, dječji vrtić i crkva, povezani uređenim pješačkim stazama.",

        lokacija_karta:
            "Pogledaj lokaciju na karti",

        lokacija_napomena:
            "Točna lokacija nekretnine dostupna je ozbiljnim zainteresiranim kupcima prilikom dogovora za razgledavanje.",
        ...
        okucnica_footer:
            "Mjesto gdje se udobnost doma nastavlja i na otvorenom.",
        ...
        osnovni_detalji_oznaka: "Pregled nekretnine",
        osnovni_detalji_naslov: "Sve važne informacije na jednom mjestu",
        osnovni_tablica_naslov: "Osnovne informacije",
        osnovni_lokacija: "Lokacija",
        osnovni_lokacija_vrijednost: "Virovitičko-podravska županija, Špišić Bukovica",
        osnovni_tip: "Tip kuće",
        osnovni_tip_vrijednost: "Samostojeća",
        osnovni_etaze: "Broj etaža",
        osnovni_etaze_vrijednost: "Prizemnica",
        osnovni_gradnja: "Vrsta gradnje",
        osnovni_gradnja_vrijednost: "Zidana kuća (beton, opeka)",
        osnovni_sobe: "Broj soba",
        osnovni_bruto: "Stambena površina",
        osnovni_neto: "Neto površina",
        osnovni_okucnica: "Površina okućnice",
        osnovni_godina: "Godina izgradnje",
        osnovni_renovacija: "Godina zadnje renovacije",
        osnovni_namjestenost: "Namještenost i stanje",
        osnovni_namjestenost_vrijednost: "Potpuno namješteno",
        osnovni_parking: "Broj parkirnih mjesta",
        osnovni_terasa: "Balkon / lođa / terasa",
        osnovni_terasa_vrijednost: "Terasa",
        osnovni_energija: "Energetski razred",
        osnovni_zamjena: "Mogućnost zamjene",
        osnovni_zamjena_vrijednost: "Moguća zamjena za drugu nekretninu",
        osnovni_znacajke_naslov: "Značajke objekta",
        osnovni_objekt_naslov: "Podaci o objektu",
        osnovni_objekt_novogradnja: "Novogradnja",
        osnovni_objekt_pristup: "Pristup za osobe s invaliditetom",
        osnovni_objekt_plin: "Gradski plin",
        osnovni_objekt_voda: "Gradski vodovod",
        osnovni_objekt_kanalizacija: "Gradska kanalizacija",
        osnovni_dozvole_naslov: "Dozvole i potvrde",
        osnovni_vlasnicki: "Vlasnički list",
        osnovni_gradevinska: "Građevinska dozvola",
        osnovni_uporabna: "Uporabna dozvola",
        osnovni_parking_naslov: "Vrsta parkinga",
        osnovni_garaza: "Garaža",
        osnovni_vanjski_parking: "Vanjsko nenatkriveno mjesto",
        osnovni_funkcionalnosti_naslov: "Funkcionalnosti i ostale karakteristike",
        osnovni_protuprovalna: "Protuprovalna vrata",
        osnovni_tus: "Tuš-kabina",
        osnovni_podno: "Podno grijanje",
        osnovni_perilica: "Perilica posuđa",
        osnovni_ostalo_naslov: "Ostali objekti i površine",
        osnovni_dvoriste: "Dvorište / vrt",
        osnovni_podrum: "Podrum",
        osnovni_spremiste: "Spremište / šupa",
        osnovni_kupaonice: "Broj kupaonica s WC-om",
    ...
    en: {
        ...
        pocetna_slogan: "Your little piece of the universe!",
        ...
        osnovni_podnaslov:
            "Happy Place — Your little piece of the universe!",
        ...
        osnovni_detalji_oznaka: "Property overview",
        osnovni_detalji_naslov: "All the key information in one place",
        osnovni_tablica_naslov: "Basic information",
        osnovni_lokacija: "Location",
        osnovni_lokacija_vrijednost: "Virovitica-Podravina County, Špišić Bukovica",
        osnovni_tip: "House type",
        osnovni_tip_vrijednost: "Detached house",
        osnovni_etaze: "Number of floors",
        osnovni_etaze_vrijednost: "Single-storey house",
        osnovni_gradnja: "Construction type",
        osnovni_gradnja_vrijednost: "Masonry house (concrete, brick)",
        osnovni_sobe: "Number of rooms",
        osnovni_bruto: "Gross living area",
        osnovni_neto: "Net floor area",
        osnovni_okucnica: "Plot area",
        osnovni_godina: "Year built",
        osnovni_renovacija: "Last renovation",
        osnovni_namjestenost: "Furnishing and condition",
        osnovni_namjestenost_vrijednost: "Fully furnished",
        osnovni_parking: "Parking spaces",
        osnovni_terasa: "Balcony / loggia / terrace",
        osnovni_terasa_vrijednost: "Terrace",
        osnovni_energija: "Energy rating",
        osnovni_zamjena: "Property exchange",
        osnovni_zamjena_vrijednost: "Exchange for another property is possible",
        osnovni_znacajke_naslov: "Property features",
        osnovni_objekt_naslov: "Property details",
        osnovni_objekt_novogradnja: "New build",
        osnovni_objekt_pristup: "Wheelchair accessible",
        osnovni_objekt_plin: "Mains gas",
        osnovni_objekt_voda: "Mains water",
        osnovni_objekt_kanalizacija: "Mains sewerage",
        osnovni_dozvole_naslov: "Permits and certificates",
        osnovni_vlasnicki: "Title deed",
        osnovni_gradevinska: "Building permit",
        osnovni_uporabna: "Occupancy permit",
        osnovni_parking_naslov: "Parking type",
        osnovni_garaza: "Garage",
        osnovni_vanjski_parking: "Uncovered outdoor space",
        osnovni_funkcionalnosti_naslov: "Amenities and other features",
        osnovni_protuprovalna: "Security door",
        osnovni_tus: "Shower enclosure",
        osnovni_podno: "Underfloor heating",
        osnovni_perilica: "Dishwasher",
        osnovni_ostalo_naslov: "Other areas and structures",
        osnovni_dvoriste: "Yard / garden",
        osnovni_podrum: "Basement",
        osnovni_spremiste: "Storage room / shed",
        osnovni_kupaonice: "Bathrooms with toilet",
    ...
    de: {
        ...
        pocetna_slogan: "Ihr kleines Stück Universum!",
        ...
        osnovni_podnaslov:
            "Happy Place — Ihr kleines Stück Universum!",
        ...
        osnovni_detalji_oznaka: "Immobilienübersicht",
        osnovni_detalji_naslov: "Alle wichtigen Informationen auf einen Blick",
        osnovni_tablica_naslov: "Grundlegende Informationen",
        osnovni_lokacija: "Lage",
        osnovni_lokacija_vrijednost: "Gespanschaft Virovitica-Podravina, Špišić Bukovica",
        osnovni_tip: "Haustyp",
        osnovni_tip_vrijednost: "Freistehendes Haus",
        osnovni_etaze: "Anzahl der Etagen",
        osnovni_etaze_vrijednost: "Erdgeschossiges Haus",
        osnovni_gradnja: "Bauart",
        osnovni_gradnja_vrijednost: "Massivhaus (Beton, Ziegel)",
        osnovni_sobe: "Zimmeranzahl",
        osnovni_bruto: "Bruttowohnfläche",
        osnovni_neto: "Nettowohnfläche",
        osnovni_okucnica: "Grundstücksfläche",
        osnovni_godina: "Baujahr",
        osnovni_renovacija: "Letzte Renovierung",
        osnovni_namjestenost: "Möblierung und Zustand",
        osnovni_namjestenost_vrijednost: "Vollständig möbliert",
        osnovni_parking: "Anzahl der Stellplätze",
        osnovni_terasa: "Balkon / Loggia / Terrasse",
        osnovni_terasa_vrijednost: "Terrasse",
        osnovni_energija: "Energieklasse",
        osnovni_zamjena: "Immobilientausch",
        osnovni_zamjena_vrijednost: "Tausch gegen eine andere Immobilie möglich",
        osnovni_znacajke_naslov: "Ausstattung der Immobilie",
        osnovni_objekt_naslov: "Objektdaten",
        osnovni_objekt_novogradnja: "Neubau",
        osnovni_objekt_pristup: "Barrierefreier Zugang",
        osnovni_objekt_plin: "Städtischer Gasanschluss",
        osnovni_objekt_voda: "Öffentliche Wasserversorgung",
        osnovni_objekt_kanalizacija: "Öffentliche Kanalisation",
        osnovni_dozvole_naslov: "Genehmigungen und Nachweise",
        osnovni_vlasnicki: "Grundbuchauszug",
        osnovni_gradevinska: "Baugenehmigung",
        osnovni_uporabna: "Nutzungsgenehmigung",
        osnovni_parking_naslov: "Parkmöglichkeiten",
        osnovni_garaza: "Garage",
        osnovni_vanjski_parking: "Nicht überdachter Außenstellplatz",
        osnovni_funkcionalnosti_naslov: "Ausstattung und weitere Merkmale",
        osnovni_protuprovalna: "Einbruchhemmende Tür",
        osnovni_tus: "Duschkabine",
        osnovni_podno: "Fußbodenheizung",
        osnovni_perilica: "Geschirrspüler",
        osnovni_ostalo_naslov: "Weitere Flächen und Gebäude",
        osnovni_dvoriste: "Hof / Garten",
        osnovni_podrum: "Keller",
        osnovni_spremiste: "Abstellraum / Schuppen",
        osnovni_kupaonice: "Badezimmer mit WC",
